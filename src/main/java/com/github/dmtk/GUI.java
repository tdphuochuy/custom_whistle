...
public class GUI extends javax.swing.JFrame {
    ...
    private final static Logger log = Logger.getLogger(GUI.class);
    ...
    private void initComponents() {
        ...
        jTextField1.setText("167.110.212.137");
        ...
        switchIPTextField.setText("167.110.212.137");
    ...
    private void jButton41ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton41ActionPerformed
        String command = ecs.showIGMPFilter(portTextField.getText());
        telnetActive.sendCommand(command);
